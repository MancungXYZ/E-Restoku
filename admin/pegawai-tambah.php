...
<html lang="en">
  ...
  <div class="container" style="margin-top:20px">
      ...
      <div class="form-group row">
				...
				<div class="col-sm-10 mt-3">
          <textarea class="form-control" name="alamat" placeholder="Masukan disini" id="floatingTextarea2" style="height: 100px"></textarea>
				</div>
			</div>
      <div class="form-group row">
    ...
    <?php
        if (isset($_POST["submit"])) {
                ...
                // Bersihkan data
                    $Id_Pegawai = $koneksi->escape_string($_POST["id_pegawai"]);
                    ...
                    // Menyusun SQL
                    $sql = "INSERT INTO pegawai(id_pegawai, nama_pegawai, password, jenis_kelamin, alamat, no_hp, posisi) VALUES('$Id_Pegawai','$Nama_Pegawai','$Password','$Jenis_Kelamin', '$Alamat','$No_Hp','$Posisi')";
